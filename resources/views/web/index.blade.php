...
@section('content')
    <!-- banner area start -->
    <section
      class="banner_area lg:pt-[70px] pt-10 relative border-b border-border_color border-opacity-20 overflow-hidden"
    >
      <div class="before_img absolute top-0 left-0">
        <img
          class="w-[300px]"
          src="{{ asset('assets/web') }}/img/banner/shap/header-left-shape-1.svg"
          alt=""
        />
      </div>
      <div class="container mx-auto">
        <div class="grid grid-cols-2 items-center relative">
          <div
            class="banner_form py-10 lg:col-span-1 col-span-2 lg:order-1 order-2"
          >
            <div class="max-w-[450px] lg:ml-0 lg:mr-auto lg:mx-0 mx-auto">
              <div class="banner_text">
                <p
                  class="text-[#5e6e82] mt-3 lg:text-lg text-base font-light font-poppins"
                >
                  Join the
                  <strong class="font-medium">Alumni Association</strong> to
                  reconnect with your friends, classmates, seniors &amp;
                  juniors.
                </p>
              </div>
              <div class="grid grid-cols-2 md:gap-5 gap-4 mt-4">
                <div class="input_group">
                  <label
                    for="email"
                    class="text-text_color text-sm font-normal font-poppins mb-1 inline-block"
                    >Email</label
                  >
                  <input
                    type="email"
                    class="border border-border_color border-opacity-50 h-11 rounded-md p-2 w-full focus-visible:border-theme_color focus-visible:outline-none"
                  />
                </div>
                <div class="input_group">
                  <label
                ...
                <div class="input_btn col-span-2">
                  <button
                    type="button"
                    class="bg-theme_color py-3 px-6 text-white text-center text-sm font-medium font-poppins rounded-md w-full"
                  >
                    Login
                  </button>
                  <a
                    href="#0"
                    class="text-theme_color text-xs font-light font-poppins inline-block mt-2"
                    >Forgot password</a
                  >
                  <button
                    type="button"
                    class="bg-theme_color bg-opacity-10 text-theme_color py-3 px-6 rounded-md text-sm font-medium font-poppins w-full flex items-center justify-center gap-2 mt-4"
                  >
                    Create an account
                    <i>
                      <svg
                        ...
                        stroke-width="1.5"
                        stroke="currentColor"
                        class="w-[14px] h-[14px] text-theme_color"
                      >
                        <path
          ...
          <div
            class="banner_thumb -mt-2 lg:col-span-1 col-span-2 lg:order-2 order-1"
          >
            <div class="lg:w-[50vw] w-full h-[450px] box-border relative">
              <div
                class="thumb_bg bg-[url('/src/img/banner/bg-1.png')] bg-left lg:w-full lg:max-w-none max-w-full h-full"
              ></div>
              <div
                class="bg_left_shap absolute top-0 left-0 right-0 bottom-0 overflow-hidden lg:block hidden"
              >
                <svg
                  viewBox="0 0 129 680"
                  fill="none"
                ...
                >
                  <path
                    d="M 98.788 0.5 L 0 0.5 L 0 680 L -0.913 680 L 98.788 0.5 Z"
                    fill="white"
                  ></path>
                </svg>
              </div>
    ...
    <section class="event_area md:pb-0 pb-14">
      <div class="container mx-auto relative">
        <div class="event_slider swiper mySwiper py-[60px!important]">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div
                class="ev_item border border-border_color border-opacity-50 rounded-md"
              >
                <div class="lg:p-8 p-5 lg:pb-5 pb-3">
                  <div class="item_img">
                    <img
                      src="{{ asset('assets/web') }}/img/event/default-event-cover.png"
                      alt=""
                    />
                  </div>
                  <div class="item_text">
                    <div
                      class="bg-theme_color bg-opacity-30 text-theme_color text-xs font-normal font-poppins rounded-3xl px-2 py-[2px] inline-block"
                    >
                    ...
                    <a
                      href="#0"
                      class="text-black lg:text-xl text-lg font-semibold font-poppins block"
                    >
                      Web winner
                    </a>
                    <div class="flex items-center gap-2 pt-2 pb-3">
                      <i>
                        <svg
                          ...
                          stroke-width="1.5"
                          stroke="currentColor"
                          class="w-6 h-6 text-theme_color"
                        >
                          <path
                            stroke-linecap="round"
                            stroke-linejoin="round"
                      ...
                      <span
                        class="text-text_color md:text-lg text-base font-medium font-poppins"
                        >May 3, 2023</span
                      >
                    </div>
                    <div
                    ...
                    >
                      <div class="flex items-center gap-1">
                        ...
                        <span
                          class="text-text_color text-opacity-75 text-sm font-normal font-poppins"
                          >People are going</span
                        >
                      </div>
                      <div class="flex items-center gap-1">
                        <i>
                          <svg
                            ...
                            stroke-width="1.5"
                            stroke="currentColor"
                            class="w-4 h-4 text-text_color text-opacity-75"
                          >
                            <path
                              stroke-linecap="round"
                              stroke-linejoin="round"
                        ...
                        <span
                          class="text-text_color text-opacity-75 text-sm font-normal font-poppins"
                          >Registration closing in May 1, 2023</span
                        >
                      </div>
                    </div>
                  </div>
                ...
                <div
                  class="item_cate border-t border-t-border_color border-opacity-30 flex items-center divide-x divide-text_color divide-opacity-30"
                >
                  <a
                    href="#0"
                    class="text-theme_color text-base font-medium font-poppins w-1/2 text-center p-3"
                    >Participate</a
                  >
                  <a
                    href="#0"
                    class="text-text_color text-base font-medium font-poppins flex items-center justify-center p-3 gap-2 w-1/2"
                  >
                    <i>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          class="swiper-button-next style_one bg-white shadow-theme_shadow h-[60px!important] w-[60px!important] rounded-full max-md:top-[95%!important]"
        ></div>
        <div
          class="swiper-button-prev style_one bg-white shadow-theme_shadow h-[60px!important] w-[60px!important] rounded-full max-md:top-[95%!important]"
        ></div>
      </div>
    </section>
    <!-- event area ends  -->
        ...
        <div class="grid md:grid-cols-9 grid-cols-2 lg:gap-10 gap-6">
          <div class="md:col-span-4 col-span-2 md:order-1 order-2">
            <div class="text_content max-w-[354px] ml-0">
              <h4
                class="text-[#344050] xl:text-4xl lg:text-3xl text-2xl font-medium font-poppins"
              >
                Your Network <br />
                Around the Globe
              </h4>
              <p
                class="text-[#9da9bb] md:text-base text-sm font-medium font-poppins my-3"
              >
              ...
              <ul class="flex items-center gap-3 divide-x my-8">
                <li>
                  <p
                    class="text-theme_color lg:text-3xl md:text-2xl text-xl font-medium font-poppins"
                  >
                    50
                  </p>
                  <span class="text-[#9da9bb] text-sm font-medium font-poppins"
                    >Members</span
                  >
                </li>
                <li class="pl-3">
              ...
              <button
                type="button"
                class="bg-theme_color py-3 px-4 rounded-md text-white text-sm font-medium font-poppins flex items-center justify-center gap-2 w-full"
              >
                Join your community
                <i>
                  <svg
          ...
          <div class="md:col-span-5 col-span-2 md:order-2 order-1">
            <div
              class="our_glob_map rounded-md border border-theme_color border-opacity-60"
            >
              <iframe
      ...
      <div class="container mx-auto">
        ...
        <div class="section_wrapper mt-12">
          <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
            <div
              class="blog_item border border-border_color border-opacity-30 rounded-md"
            >
              <div class="item_thumb">
                <img
                  class="w-full rounded-tl-md rounded-tr-md"
                  src="{{ asset('assets/web') }}/img/blog/blog-1.jpg"
                  alt=""
                />
              </div>
              <div class="item_text">
                <div class="p-5">
                  <a href="#0">
                    <h4
                      class="text-[#4d5969] xl:text-xl md:text-lg text-base font-medium font-poppins pb-3"
                    >
                      Mentoring is a great way for our alumni community to
                      connect with each other and our students.
                    </h4>
                  </a>
                  <p class="text-[#9da9bb] text-base font-medium font-poppins">
                    We caught up with MBA graduate and podcaster, Reza Haque,
                    and second-year Fine Art student
                  </p>
                </div>
                <a
                  href="news-details.html"
                  class="p-5 rounded-bl-md rounded-br-md border-t border-t-border_color border-opacity-30 text-theme_color flex items-center gap-2 text-sm font-medium font-poppins"
                >
                  Read more
                  <i>
                    <svg
                      ...
                      stroke-width="1.5"
                      stroke="currentColor"
                      class="w-5 h-5 text-theme_color"
                    >
                      <path
                        stroke-linecap="round"
                        stroke-linejoin="round"
            ...
            >
              <div class="item_thumb">
                <img
                  class="w-full rounded-tl-md rounded-tr-md"
                  src="{{ asset('assets/web') }}/img/blog/blog-2.jpg"
                  alt=""
                />
              </div>
              <div class="item_text">
            ...
            >
              <div class="item_thumb">
                <img
                  class="w-full rounded-tl-md rounded-tr-md"
                  src="{{ asset('assets/web') }}/img/blog/blog-3.jpg"
                  alt=""
                />
              </div>
              <div class="item_text">
        ...
        <div class="story_slider">
          <div class="grid grid-cols-2 items-center relative">
            <div class="banner_thumb lg:col-span-1 col-span-2 relative">
              <div
                class="thumb_bg bg-[url('/src/img/story/01.jpg')] lg:w-[57vw] w-full lg:min-h-[400px] min-h-[200px] bg-cover lg:bg-left-top bg-center overflow-hidden will-change-transform bg-no-repeat float-right"
              ></div>
              <div
                class="bg_shape absolute inset-0 overflow-hidden lg:block hidden"
              >
                <svg
                  viewBox="0 0 122 496"
                  fill="none"
                  class="absolute inset-0 left-auto origin-center w-auto h-full scale-100"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <div class="story_content lg:p-20 p-5 lg:col-span-1 col-span-2">
              <div class="content_inner max-w-[450px]">
                <h4
                  class="text-[#344050] lg:text-3xl text-xl font-normal font-poppins pb-2"
                >
                  Distribution of winter clothing to the underprivileged
                </h4>
                <p
                  class="text-[#9da9bb] md:text-base text-start font-normal font-poppins"
                >
                  Even though the winter is welcomed by the privileged wealthy
                  people by colorful pashminas and festive moods, it brings a
                </p>
                <div class="flex items-center gap-5 mt-7">
                  <button
                    type="button"
                    class="bg-theme_color text-white text-sm font-medium font-poppins py-2 px-4 rounded-md flex items-center gap-1"
                  >
                    Read full story
                    <i>
                      <svg
                  ...
                  <button
                    type="button"
                    class="bg-[#edf2f9] text-theme_color text-sm font-medium font-poppins py-2 px-4 rounded-md flex items-center gap-1"
                  >
                    All stories
                    <i>
                      <svg
